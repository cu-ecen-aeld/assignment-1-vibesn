...
const char *actual_user;

expected_user = my_username();
actual_user = malloc_username_from_conf_file();

TEST_ASSERT_EQUAL_STRING_MESSAGE(expected_user, actual_user, "Failure: Expected user is not the user signed on!");
